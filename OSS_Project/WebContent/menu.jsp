	...
	<div class="container">
		...
		<form action="/MenuResult.do" method="get">>
			<fieldset>
				...
				<h4>
				&nbsp;
				<label><input type="radio" name="Category" value="한식">&nbsp;한식</label>&ensp;
				<label><input type="radio" name="Category" value="중식">&nbsp;중식</label>&ensp;
				<label><input type="radio" name="Category" value="일식">&nbsp;일식</label>&ensp;
				<label><input type="radio" name="Category" value="양식">&nbsp;양식</label>&ensp;
				</h4>
				<!-- 개행 부분 -->
				<br><br>
				<!-- /개행 부분 -->
				...
				<h4>
				&nbsp;
				<label><input type="radio" name="Taste" value="매운맛">&nbsp;매운맛</label>&ensp;
				<label><input type="radio" name="Taste" value="짠맛">&nbsp;짠맛</label>&ensp;
				<label><input type="radio" name="Taste" value="단맛">&nbsp;단맛</label>&ensp;
				</h4>
				<!-- 개행 부분 -->
				<br>
				<!-- /개행 부분 -->
